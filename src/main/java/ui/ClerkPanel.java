...
public class ClerkPanel extends JPanel {
    ...
    /**
     * Constructor for ClerkPanel
     * @param parentFrame The parent frame
     */
    public ClerkPanel(LibraryUI parentFrame) {
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel titleLabel = new JLabel("Clerk Dashboard");
        ...
        JLabel userLabel = new JLabel("Logged in as Clerk");
    ...
    public void refreshData() {
        // Update current clerk
        clerk = (Clerk) authController.getCurrentUser();
